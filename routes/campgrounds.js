...
router.get("/:id/edit", middleware.checkCamgproundOwnership, function(req, res){
...
router.put("/:id", middleware.checkCamgproundOwnership, function(req, res){
...
router.delete("/:id", middleware.checkCamgproundOwnership, function(req, res){
